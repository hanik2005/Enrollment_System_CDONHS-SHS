...
<form action="../Back_End_Files/PHP_Files/student_enrollment_backend.php" 
    ...
    <div id="permanentAddressDiv" style="display: none;">
        <div class="form-grid">
            ...
            <div>
                <label>Permanent House No. / Street</label>
                <input type="text" name="permanentHouseNumber">
            </div>

            <div>
                <label>Permanent Barangay</label>
                <input type="text" name="permanentBarangay">
            </div>
            ...
            <div>
                ...
                <input type="text" name="permanentProvince">
            </div>
