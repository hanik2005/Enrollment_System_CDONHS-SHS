...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $cityMunicipality = $_POST['cityMunicipality'] ?? null;
    ...
    $permanentHouseNumber = $_POST['permanentHouseNumber'] ?? null;
    $permanentStreet = $_POST['permanentStreet'] ?? null;
    $permanentBarangay = $_POST['permanentBarangay'] ?? null;
    $permanentCity = $_POST['permanentCity'] ?? null;
    $permanentProvince = $_POST['permanentProvince'] ?? null;
    $permanentCountry = $_POST['permanentCountry'] ?? 'Philippines';
    $permanentZipCode = $_POST['permanentZipCode'] ?? null;

    if ($sameAsCurrent === 'Yes') {
        $permanentHouseNumber = $houseNumber;
        $permanentStreet = $street;
        $permanentBarangay = $barangay;
        $permanentCity = $cityMunicipality;
    ...
    $houseNumber,$street,$barangay,$cityMunicipality,$province,$country,$zipCode,
    $sameAsCurrent,$permanentHouseNumber,$permanentStreet,$permanentBarangay,
    $permanentCity,$permanentProvince,$permanentCountry,$permanentZipCode,
